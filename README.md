...
_Option modules_ are what you'd typically call a module in the Nix ecosystem.
...
If you want to use the Home Manager options, you'd import them in a Home Manager
module.
